...
<head>
  ...
  <style>
    ...
    .snapshot-table .deadline-value { color: #E05700; font-weight: 700; }
    ...
    <div class="section">
      ...
      <table class="snapshot-table">
        <tr>
          ...
          <td class="deadline-value">${submissionDeadline}</td>
        </tr>
        <tr>
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const subject = `Intelligence Brief: ${rfpTitle} | ProposalPilot BFSI`;
